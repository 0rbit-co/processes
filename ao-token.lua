...
local function _loaded_mod_mint()
  ...
  Mint Module handles the minting functions for AO Token
    ...
    local INSERT_ORACLE_SQL =
    "INSERT INTO Oracles (Oracle, Name, StartTimestamp, DelayDepositInterval) VALUES (?, ?, ?, ?)"
            ...
            if msg.Format and msg.Format == "Event-List" then
                ...
                for i = 1, #events do
                    ...
                    if event.Action == "Deposit" then
                        ...
                        insertDeposit(event.Recipient, msg.From, event.User, event.Token, event.TokenAmount,
                            msg.Timestamp)
